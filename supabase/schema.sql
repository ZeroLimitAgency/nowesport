...
values
  ('fr', 'home', 'hero', 'Accueil', 'NOW eSport', 'Découvrez NOW Esport, ses équipes et ses actualités.', 'Découvrir la boutique', '/shop', 'Voir les rosters', '/roster', null, '{"sponsors":[]}'::jsonb, 10),
  ('en', 'home', 'hero', 'Home', 'NOW eSport', 'Discover NOW Esport, its teams and latest updates.', 'Discover the shop', '/shop', 'View rosters', '/roster', null, '{"sponsors":[]}'::jsonb, 10),
  ('fr', 'shop', 'intro', 'Boutique', 'La boutique NOW Esport', 'Retrouvez ici les produits officiels disponibles.', null, null, null, null, null, '{}'::jsonb, 20),
  ('en', 'shop', 'intro', 'Shop', 'The NOW Esport shop', 'Find currently available official products here.', null, null, null, null, null, '{}'::jsonb, 20),
  ('fr', 'shop', 'banner', 'Boutique', 'Découvrez nos collections', 'Consultez les produits actuellement disponibles dans la boutique NOW Esport.', 'Voir les produits', '/shop', null, null, null, '{}'::jsonb, 21),
  ('en', 'shop', 'banner', 'Shop', 'Discover our collections', 'Browse the products currently available from NOW Esport.', 'View products', '/shop', null, null, null, '{}'::jsonb, 21),
  ('fr', 'roster', 'intro', 'Roster', 'Nos équipes', 'Retrouvez les équipes, joueurs et membres du staff publiés par NOW Esport.', null, null, null, null, null, '{}'::jsonb, 30),
  ('en', 'roster', 'intro', 'Roster', 'Our teams', 'Discover the teams, players and staff published by NOW Esport.', null, null, null, null, null, '{}'::jsonb, 30),
  ('fr', 'events', 'intro', 'Événements', 'Nos événements', 'Retrouvez les événements publics de NOW Esport.', null, null, null, null, null, '{}'::jsonb, 40),
  ('en', 'events', 'intro', 'Events', 'Our events', 'Find NOW Esport public events here.', null, null, null, null, null, '{}'::jsonb, 40),
  ('fr', 'partners', 'intro', 'Partenaires', 'Nos partenaires', 'Découvrez les partenaires officiels de NOW Esport.', null, null, null, null, null, '{}'::jsonb, 50),
  ('en', 'partners', 'intro', 'Partners', 'Our partners', 'Discover NOW Esport''s official partners.', null, null, null, null, null, '{}'::jsonb, 50),
  ...
  ('fr', 'legal', 'mentions-legales', 'Légal', 'Mentions légales', 'Éditeur, hébergement, propriété intellectuelle et contact légal NOW eSport.', null, null, null, null, null, '{"sections":["NOW eSport édite ce site pour présenter sa structure, ses équipes, ses partenaires et sa boutique.","Les informations légales définitives sont publiées depuis le CMS après validation par NOW Esport."]}'::jsonb, 70),
  ...
  ('fr', 'legal', 'cgv', 'Légal', 'Conditions générales de vente', 'Conditions applicables aux commandes passées sur la boutique NOW eSport.', null, null, null, null, null, '{"sections":["Les conditions applicables sont publiées après validation de la politique commerciale de NOW Esport."]}'::jsonb, 72),
  ('en', 'legal', 'cgv', 'Legal', 'Terms of sale', 'Terms applicable to orders placed on the NOW eSport shop.', null, null, null, null, null, '{"sections":["Applicable terms are published after NOW Esport validates its commercial policy."]}'::jsonb, 72),
  ('fr', 'footer', 'main', null, 'NOW eSport', 'Retrouvez les équipes, événements et informations officielles de NOW Esport.', null, null, null, null, null, '{}'::jsonb, 80),
  ('en', 'footer', 'main', null, 'NOW eSport', 'Find NOW Esport teams, events and official information.', null, null, null, null, null, '{}'::jsonb, 80)
