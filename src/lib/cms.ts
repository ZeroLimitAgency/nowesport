...
const defaultBlocksByLocale: Record<SiteLocale, Record<string, CmsBlock>> = {
  fr: {
    "home.hero": {
      ...
      eyebrow: "Accueil",
      title: "NOW eSport",
      body: "Une entrée plein écran avec vidéo, sponsors et accès rapide aux modules publics.",
    ...
    "shop.intro": {
      ...
      body: "La boutique est pensée pour accueillir tes vraies collections, tes médias, tes options de personnalisation, les tailles, le flocage, les prix et les futurs moyens de paiement.",
    },
    "shop.banner": {
      area: "shop",
      key: "banner",
    ...
    "roster.intro": {
      ...
      body: "Les rosters publics restent gérés dans le module métier roster, tandis que ce texte éditorial est pilotable depuis le CMS.",
    },
    "events.intro": {
      area: "events",
      key: "intro",
      ...
      body: "La page événements reprend la logique timeline avec points reliés, image, titre, date et description.",
    },
    "partners.intro": {
      area: "partners",
      key: "intro",
      ...
      body: "Chaque partenaire est pensé comme un bloc éditorial avec image, nom, description et lien configurable.",
    },
    "maintenance.main": {
      area: "maintenance",
      key: "main",
  ...
  en: {
    "home.hero": {
      ...
      eyebrow: "Home",
      title: "NOW eSport",
      body: "A full-screen entry with video, sponsors and quick access to public modules.",
    ...
    "shop.intro": {
      ...
      body: "The shop is ready for real collections, media, customization options, sizes, flocking, prices and future payment methods.",
    },
    "shop.banner": {
      area: "shop",
      key: "banner",
    ...
    "roster.intro": {
      ...
      body: "Public rosters remain in the roster business module, while this editorial copy is managed in the CMS.",
    },
    "events.intro": {
      area: "events",
      key: "intro",
      ...
      body: "The events page uses a connected timeline with images, title, date and description.",
    },
    "partners.intro": {
      area: "partners",
      key: "intro",
      ...
      body: "Each partner is displayed as an editorial block with configurable image, name, description and redirect link.",
    },
    "maintenance.main": {
      area: "maintenance",
      key: "main",
