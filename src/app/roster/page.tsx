  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
      <PageIntro
        ...
        description="Chaque jeu peut accueillir plusieurs rosters. La structure est prête pour Fortnite, Counter-Strike 2, Rocket League, Valorant, puis pour les blocs NOW Team et Legends."
      />
